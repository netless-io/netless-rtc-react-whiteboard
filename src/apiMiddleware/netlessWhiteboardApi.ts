...
export const netlessWhiteboardApi = new class {
    ...
    public readonly recordFactory: (channelName: string, userId: string, storageConfig: any, recordingConfig?: any) => RecordOperator = function (channelName: string, userId: string, storageConfig: any, recordingConfig?: any): RecordOperator {
        return new RecordOperator(rtcAppId.restId, rtcAppId.restSecret, channelName, userId, storageConfig, recordingConfig);
    };
};
